  ...
  const situations = [
    {
      icon: "💰",
      text: "年金だけで払えるか心配...",
      solution: "年金範囲内での予算プラン・分割払い・費用相談"
    },
    {
      icon: "🏛️",
      text: "生活保護で引っ越し代は出るの？",
      solution: "生活保護対応・役所手続き代行・費用立替可能"
    },
    {
      icon: "💬",
      text: "ケアマネさんに相談しにくくて...",
      solution: "直接ご相談OK・ケアマネとの調整も代行します"
    },
    {
      icon: "📅",
      text: "土日しか時間が取れなくて...",
      solution: "土日祝日対応・夜間相談・お客様のスケジュール最優先"
    },
    {
      icon: "❓",
      text: "何から始めればいいか全然わからない...",
      solution: "まずは現状確認・段階的プラン・わかりやすくご説明"
    },
    {
      icon: "📋",
      text: "役所の手続きも一緒にお願いできる？",
      solution: "各種手続き代行・書類作成・役所同行サポート"
    }
  ];
